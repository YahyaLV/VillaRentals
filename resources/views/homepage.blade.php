            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        <a onclick="return confirm('login first !')" href="{{url('/login')}}" class="nav-item nav-link active">booking</a>
                        <a href="about.html" class="nav-item nav-link">About</a>
                        <a href="service.html" class="nav-item nav-link">Contact</a>
                        <a href="{{url('/login')}}" class="nav-item nav-link">login</a>
                        <a href="{{url('/registrer')}}" class="nav-item nav-link">register</a>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 800px;">
                            ...
                            <a onclick="return confirm('login first !')" href="{{url('/login')}}" class="btn btn-primary py-md-3 px-md-5 mt-2 mt-md-4">booking</a>
                        </div>
                    </div>
                </div>
